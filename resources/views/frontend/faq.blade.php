...
<!-- Mirrored from labartisan.net/demo/halci/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Dec 2022 06:26:01 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
						...
						<ul class="search-cart">
							<li class="cart">
								...
								<div class="cart-content">
									...
									<div class="cart-item">
										<div class="cart-img">
											<a href="#"><img src="assets/images/logo/01.png" alt="cart"></a>
										</div>
										<div class="cart-des">
											<a href="#">Product Title Hore</a>
											<p>$20.00</p>
			...
			<div class="container">
				<div class="banner-content">
					...
					<ul class="banner-link">
						...
						<li><span>/</span></li>
						<li><a class="active">Faq Pager</a></li>
					</ul>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-4 col-12">
					<div class="faq-tab">
						...
						<ul class="nav nav-tabs" id="myTab" role="tablist">
							<li class="nav-item">
								<a class="nav-link active" id="purchas-tab" data-toggle="tab" href="#purchas" role="tab" aria-controls="purchas" aria-selected="true">Customer Support</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" id="returns-tab" data-toggle="tab" href="#returns" role="tab" aria-controls="returns" aria-selected="false">License</a>
							</li>
							<li class="nav-item">
							...
							<li class="nav-item">
								<a class="nav-link" id="care-tab" data-toggle="tab" href="#care" role="tab" aria-controls="care" aria-selected="false">Purchasing Online</a>
							</li>
							<li class="nav-item">
							...
							<div id="accordion">
								<div class="card">
									<div class="card-header" id="headingOne">
										<h5 class="mb-0">
											<button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
												Can I cancel or change my order?<i class="fa fa-plus"></i><i class="fa fa-minus"></i>
											</button>
										</h5>
									</div>
									...
									<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
										<div class="card-body">
											Fusce dignissim, diam quis faucibus posuere, metus ipsum dictum Edite 
											dapibus quam lectus nec magna. Nunc fermentum felis eu pulvinar over 
											nulla sodales nisi est, a rutrum urna egestas vitae. 
										</div>
									</div>
								</div>
								<div class="card">
									...
									<div class="card-header" id="headingThree">
										<h5 class="mb-0">
											<button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
												How can I pay for my purchases?<i class="fa fa-plus"></i><i class="fa fa-minus"></i>
											</button>
										</h5>
									</div>
									...
									<div class="card-header" id="headingfour">
										<h5 class="mb-0">
											<button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapsefour" aria-expanded="false" aria-controls="collapsefour">
												Is there a warranty on my item?<i class="fa fa-plus"></i><i class="fa fa-minus"></i>
											</button>
										</h5>
									</div>
									...
									<div class="card-header" id="headingfive">
										<h5 class="mb-0">
											<button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapsefive" aria-expanded="false" aria-controls="collapsefive">
												How safe is it to order online?<i class="fa fa-plus"></i><i class="fa fa-minus"></i>
											</button>
										</h5>
									</div>
									...
									<div class="card-header" id="heading10">
										<h5 class="mb-0">
											<button class="btn btn-link" data-toggle="collapse" data-target="#collapse10" aria-expanded="true" aria-controls="collapse10">
												How do I repair an item?<i class="fa fa-plus"></i><i class="fa fa-minus"></i>
											</button>
										</h5>
									</div>
									...
									<div class="card-header" id="heading11">
										<h5 class="mb-0">
											<button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse11" aria-expanded="false" aria-controls="collapse11">
												Where can I find instructions on how to use my watch?<i class="fa fa-plus"></i><i class="fa fa-minus"></i>
											</button>
										</h5>
									</div>
						...
						<div class="tab-pane fade" id="Technical" role="tabpanel" aria-labelledby="Technical-tab">
							...
							<div id="accordion5">
								<div class="card">
									...
									<div id="collapse20" class="collapse show" aria-labelledby="heading20" data-parent="#accordion5">
										<div class="card-body">
											Why I say old chap that is spiffing pukka, bamboozled wind up bugger buggered zonked hanky panky a blinding shot the little rotter, bubble and squeak vagabond cheeky bugger at public school pardon you bloke the BBC. Tickety-boo Elizabeth plastered matie.!
										</div>
									</div>
