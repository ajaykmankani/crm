...
<!-- Mirrored from labartisan.net/demo/halci/portfolio-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Dec 2022 06:26:03 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
			...
			<div class="container">
				<div class="banner-content text-center">
					...
					<ul class="banner-link">
						...
						<li><span>/</span></li>
						<li><a class="active">Portfolio 2 Columns</a></li>
					</ul>
				</div>
			</div>
		</div>
				...
				<div class="grid">
					<div class="grid-item lp pr br">
						<div class="portfolio-thumb">
							<div class="portfolio-image">
								<img src="assets/images/portfolio/0.jpg" alt="portfolio">
							</div>
							<div class="hover_content">
								<a href="assets/images/portfolio/0.jpg" class="img_popup leaf" data-rel="lightcase:myCollection">
					...
					<div class="grid-item cr ap br lp">
						<div class="portfolio-thumb">
							...
							<div class="hover_content">
								<a href="assets/images/portfolio/01.html" class="img_popup leaf" data-rel="lightcase:myCollection">
									<i class="fas fa-plus"></i>
								</a>
								<div class="portfolio-description leaf text-center">
									<a href="work-default.html" class="portfolio-title">
										<h5 class="f_500 f_size_20 f_p">Sumsung Apps Mockup</h5>
									</a>
									<div class="links"><a href="#">Branding,</a><a href="#">Fashion</a></div>
								</div>
							</div>
					...
					<div class="grid-item pr ap lp">
						<div class="portfolio-thumb">
							...
							<div class="hover_content">
								<a href="assets/images/portfolio/02.jpg" class="img_popup leaf" data-rel="lightcase:myCollection">
									<i class="fas fa-plus"></i>
								</a>
								<div class="portfolio-description leaf text-center">
									<a href="work-default.html" class="portfolio-title">
										<h5 class="f_500 f_size_20 f_p">Portfolio Content Slider</h5>
									</a>
									<div class="links"><a href="#">Branding,</a><a href="#">Fashion</a></div>
								</div>
							</div>
					...
					<div class="grid-item cr pr br">
						<div class="portfolio-thumb">
							...
							<div class="hover_content">
								<a href="assets/images/portfolio/03.jpg" class="img_popup leaf" data-rel="lightcase:myCollection">
									<i class="fas fa-plus"></i>
								</a>
								<div class="portfolio-description leaf text-center">
									<a href="work-default.html" class="portfolio-title">
										<h5 class="f_500 f_size_20 f_p">Bata My Collection</h5>
									</a>
									<div class="links"><a href="#">Branding,</a><a href="#">Fashion</a></div>
								</div>
							</div>
					...
					<div class="grid-item cr br pr lp">
						<div class="portfolio-thumb">
							...
							<div class="hover_content">
								<a href="assets/images/portfolio/04.jpg" class="img_popup leaf" data-rel="lightcase:myCollection">
									<i class="fas fa-plus"></i>
								</a>
								<div class="portfolio-description leaf text-center">
									<a href="work-default.html" class="portfolio-title">
										<h5 class="f_500 f_size_20 f_p">Portfolio Color Collection</h5>
									</a>
									<div class="links"><a href="#">Branding,</a><a href="#">Fashion</a></div>
								</div>
							</div>
					...
					<div class="grid-item cr lp br ap">
						<div class="portfolio-thumb">
							...
							<div class="hover_content">
								<a href="assets/images/portfolio/05.jpg" class="img_popup leaf" data-rel="lightcase:myCollection">
									<i class="fas fa-plus"></i>
								</a>
								<div class="portfolio-description leaf text-center">
									<a href="work-default.html" class="portfolio-title">
										<h5 class="f_500 f_size_20 f_p">Pnasomic Electronics Eliment</h5>
									</a>
									<div class="links"><a href="#">Branding,</a><a href="#">Fashion</a></div>
								</div>
							</div>
...
<!-- Mirrored from labartisan.net/demo/halci/portfolio-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Dec 2022 06:26:06 GMT -->
</html>