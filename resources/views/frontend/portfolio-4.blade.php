...
<!-- Mirrored from labartisan.net/demo/halci/portfolio-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Dec 2022 06:26:11 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
			...
			<div class="container">
				<div class="banner-content text-center">
					...
					<ul class="banner-link">
						...
						<li><span>/</span></li>
						<li><a class="active">Portfolio 4 Columns</a></li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="portfolio-wrapper">
				...
				<div class="grid">
					<div class="grid-item lp pr br">
						<div class="portfolio-thumb">
							<div class="portfolio-image">
								<img src="assets/images/portfolio/13.jpg" alt="portfolio">
							</div>
							<div class="hover_content">
								<a href="assets/images/portfolio/13.jpg" class="img_popup leaf" data-rel="lightcase:myCollection">
									<i class="fas fa-plus"></i>
								</a>
								<div class="portfolio-description leaf text-center">
									<a href="#" class="portfolio-title">
										<h5 class="f_500 f_size_20 f_p">Rainbo Seramics</h5>
									</a>
					...
					<div class="grid-item cr ap br lp">
						<div class="portfolio-thumb">
							<div class="portfolio-image">
								<img src="assets/images/portfolio/14.jpg" alt="portfolio">
							</div>
							<div class="hover_content">
								<a href="assets/images/portfolio/14.jpg" class="img_popup leaf" data-rel="lightcase:myCollection">
									<i class="fas fa-plus"></i>
								</a>
								<div class="portfolio-description leaf text-center">
									<a href="#" class="portfolio-title">
					...
					<div class="grid-item pr ap lp">
						<div class="portfolio-thumb">
							<div class="portfolio-image">
								<img src="assets/images/portfolio/15.jpg" alt="portfolio">
							</div>
							<div class="hover_content">
								<a href="assets/images/portfolio/15.jpg" class="img_popup leaf" data-rel="lightcase:myCollection">
									<i class="fas fa-plus"></i>
								</a>
								<div class="portfolio-description leaf text-center">
									<a href="#" class="portfolio-title">
					...
					<div class="grid-item cr pr br">
						<div class="portfolio-thumb">
							<div class="portfolio-image">
								<img src="assets/images/portfolio/16.jpg" alt="portfolio">
							</div>
							<div class="hover_content">
								<a href="assets/images/portfolio/16.jpg" class="img_popup leaf" data-rel="lightcase:myCollection">
									<i class="fas fa-plus"></i>
								</a>
								<div class="portfolio-description leaf text-center">
									<a href="#" class="portfolio-title">
										<h5 class="f_500 f_size_20 f_p">Caseo Calculator</h5>
									</a>
									<div class="links"><a href="#">Branding,</a><a href="#">Fashion</a></div>
								</div>
							</div>
					...
					<div class="grid-item cr br pr lp">
						<div class="portfolio-thumb">
							<div class="portfolio-image">
								<img src="assets/images/portfolio/17.jpg" alt="portfolio">
							</div>
							<div class="hover_content">
								<a href="assets/images/portfolio/17.jpg" class="img_popup leaf" data-rel="lightcase:myCollection">
									<i class="fas fa-plus"></i>
								</a>
								<div class="portfolio-description leaf text-center">
									<a href="#" class="portfolio-title">
										<h5 class="f_500 f_size_20 f_p">Mk Clock</h5>
									</a>
									<div class="links"><a href="#">Branding,</a><a href="#">Fashion</a></div>
								</div>
							</div>
					...
					<div class="grid-item ap lp cr">
						<div class="portfolio-thumb">
							<div class="portfolio-image">
								<img src="assets/images/portfolio/18.jpg" alt="portfolio">
							</div>
							<div class="hover_content">
								<a href="assets/images/portfolio/18.jpg" class="img_popup leaf" data-rel="lightcase:myCollection">
									<i class="fas fa-plus"></i>
								</a>
								<div class="portfolio-description leaf text-center">
									<a href="#" class="portfolio-title">
										<h5 class="f_500 f_size_20 f_p">Sony DHLR</h5>
									</a>
									<div class="links"><a href="#">Branding,</a><a href="#">Fashion</a></div>
								</div>
							</div>
					...
					<div class="grid-item cr lp br ap">
						<div class="portfolio-thumb">
							<div class="portfolio-image">
								<img src="assets/images/portfolio/19.jpg" alt="portfolio">
							</div>
							<div class="hover_content">
								<a href="assets/images/portfolio/19.jpg" class="img_popup leaf" data-rel="lightcase:myCollection">
									<i class="fas fa-plus"></i>
								</a>
								<div class="portfolio-description leaf text-center">
									<a href="#" class="portfolio-title">
					...
					<div class="grid-item lp cr ap br">
						<div class="portfolio-thumb">
							<div class="portfolio-image">
								<img src="assets/images/portfolio/20.jpg" alt="portfolio">
							</div>
							<div class="hover_content">
								<a href="assets/images/portfolio/20.jpg" class="img_popup leaf" data-rel="lightcase:myCollection">
									<i class="fas fa-plus"></i>
								</a>
								<div class="portfolio-description leaf text-center">
									<a href="#" class="portfolio-title">
										<h5 class="f_500 f_size_20 f_p">Sprint Shows</h5>
									</a>
									<div class="links"><a href="#">Branding,</a><a href="#">Fashion</a></div>
								</div>
							</div>
...
<!-- Mirrored from labartisan.net/demo/halci/portfolio-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Dec 2022 06:26:15 GMT -->
</html>