...
<!-- Mirrored from labartisan.net/demo/halci/portfolio-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Dec 2022 06:26:08 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
						...
						<ul class="search-cart">
							<li class="cart">
								...
								<div class="cart-content">
									<div class="cart-item">
										<div class="cart-img">
											<a href="#"><img src="assets/images/logo/images.png" alt="cart"></a>
										</div>
										<div class="cart-des">
									...
									<div class="cart-item">
										<div class="cart-img">
											<a href="#"><img src="assets/images/logo/02.png" alt="cart"></a>
										</div>
										<div class="cart-des">
											<a href="#">Product Title Hore</a>
											<p>$20.00</p>
			...
			<div class="container">
				<div class="banner-content text-center">
					...
					<ul class="banner-link">
						...
						<li><span>/</span></li>
						<li><a class="active">Portfolio Grid Masonary</a></li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="portfolio-wrapper">
				<div class="portfolio-list">
					<ul class="portfolio-menu button-group">
						...
						<li class="button" data-filter=".br">Branding</li>
						<li class="button" data-filter=".cr">Creativr</li>
						<li class="button" data-filter=".lp">Laptop</li>
						<li class="button" data-filter=".pr">Product</li>
					</ul>
				</div>
				<div class="grid">
					<div class="grid-item lp pr br">
						<div class="portfolio-thumb">
							<div class="portfolio-image">
								<img src="assets/images/portfolio/21.jpg" alt="portfolio">
							</div>
							<div class="hover_content">
								<a href="assets/images/portfolio/21.jpg" class="img_popup leaf" data-rel="lightcase:myCollection">
									<i class="fas fa-plus"></i>
								</a>
								<div class="portfolio-description leaf text-center">
									<a href="#" class="portfolio-title">
										<h5 class="f_500 f_size_20 f_p">Ranibo seramics</h5>
									</a>
					...
					<div class="grid-item cr ap br lp">
						<div class="portfolio-thumb">
							<div class="portfolio-image">
								<img src="assets/images/portfolio/22.jpg" alt="portfolio">
							</div>
							<div class="hover_content">
								<a href="assets/images/portfolio/22.jpg" class="img_popup leaf" data-rel="lightcase:myCollection">
									<i class="fas fa-plus"></i>
								</a>
								<div class="portfolio-description leaf text-center">
									<a href="#" class="portfolio-title">
										<h5 class="f_500 f_size_20 f_p">Pailack color</h5>
									</a>
									<div class="links"><a href="#">Branding,</a><a href="#">Fashion</a></div>
								</div>
							</div>
					...
					<div class="grid-item pr ap lp">
						<div class="portfolio-thumb">
							<div class="portfolio-image">
								<img src="assets/images/portfolio/23.jpg" alt="portfolio">
							</div>
							<div class="hover_content">
								<a href="assets/images/portfolio/23.jpg" class="img_popup leaf" data-rel="lightcase:myCollection">
									<i class="fas fa-plus"></i>
								</a>
								<div class="portfolio-description leaf text-center">
									<a href="#" class="portfolio-title">
										<h5 class="f_500 f_size_20 f_p">Head Phone</h5>
									</a>
									<div class="links"><a href="#">Branding,</a><a href="#">Fashion</a></div>
								</div>
							</div>
					...
					<div class="grid-item cr pr br">
						<div class="portfolio-thumb">
							<div class="portfolio-image">
								<img src="assets/images/portfolio/26.jpg" alt="portfolio">
							</div>
							<div class="hover_content">
								<a href="assets/images/portfolio/26.jpg" class="img_popup leaf" data-rel="lightcase:myCollection">
									<i class="fas fa-plus"></i>
								</a>
								<div class="portfolio-description leaf text-center">
									<a href="#" class="portfolio-title">
										<h5 class="f_500 f_size_20 f_p">Pnasomic radio</h5>
									</a>
									<div class="links"><a href="#">Branding,</a><a href="#">Fashion</a></div>
								</div>
							</div>
					...
					<div class="grid-item cr br pr lp">
						<div class="portfolio-thumb">
							<div class="portfolio-image">
								<img src="assets/images/portfolio/24.jpg" alt="portfolio">
							</div>
							<div class="hover_content">
								<a href="assets/images/portfolio/24.jpg" class="img_popup leaf" data-rel="lightcase:myCollection">
									<i class="fas fa-plus"></i>
								</a>
								<div class="portfolio-description leaf text-center">
									<a href="#" class="portfolio-title">
										<h5 class="f_500 f_size_20 f_p">Bata Collection</h5>
									</a>
									<div class="links"><a href="#">Branding,</a><a href="#">Fashion</a></div>
								</div>
							</div>
					...
					<div class="grid-item ap lp cr">
						<div class="portfolio-thumb">
							<div class="portfolio-image">
								<img src="assets/images/portfolio/25.jpg" alt="portfolio">
							</div>
							<div class="hover_content">
								<a href="assets/images/portfolio/25.jpg" class="img_popup leaf" data-rel="lightcase:myCollection">
									<i class="fas fa-plus"></i>
								</a>
								<div class="portfolio-description leaf text-center">
									<a href="#" class="portfolio-title">
										<h5 class="f_500 f_size_20 f_p">Pnasomic Clock</h5>
									</a>
									<div class="links"><a href="#">Branding,</a><a href="#">Fashion</a></div>
								</div>
							</div>
					...
					<div class="grid-item cr lp br ap">
						<div class="portfolio-thumb">
							<div class="portfolio-image">
								<img src="assets/images/portfolio/29.jpg" alt="portfolio">
							</div>
							<div class="hover_content">
								<a href="assets/images/portfolio/29.jpg" class="img_popup leaf" data-rel="lightcase:myCollection">
									<i class="fas fa-plus"></i>
								</a>
								<div class="portfolio-description leaf text-center">
									<a href="#" class="portfolio-title">
										<h5 class="f_500 f_size_20 f_p">BMW Car</h5>
									</a>
									<div class="links"><a href="#">Branding,</a><a href="#">Fashion</a></div>
								</div>
							</div>
					...
					<div class="grid-item lp cr ap br">
						<div class="portfolio-thumb">
							<div class="portfolio-image">
								<img src="assets/images/portfolio/27.jpg" alt="portfolio">
							</div>
							<div class="hover_content">
								<a href="assets/images/portfolio/27.jpg" class="img_popup leaf" data-rel="lightcase:myCollection">
									<i class="fas fa-plus"></i>
								</a>
								<div class="portfolio-description leaf text-center">
									<a href="#" class="portfolio-title">
										<h5 class="f_500 f_size_20 f_p">Sumsung brandi</h5>
									</a>
									<div class="links"><a href="#">Branding,</a><a href="#">Fashion</a></div>
								</div>
							</div>
					...
					<div class="grid-item ap cr br">
						<div class="portfolio-thumb">
							<div class="portfolio-image">
								<img src="assets/images/portfolio/28.jpg" alt="portfolio">
							</div>
							<div class="hover_content">
								<a href="assets/images/portfolio/28.jpg" class="img_popup leaf" data-rel="lightcase:myCollection">
									<i class="fas fa-plus"></i>
								</a>
								<div class="portfolio-description leaf text-center">
									<a href="#" class="portfolio-title">
										<h5 class="f_500 f_size_20 f_p">Bata Showg</h5>
									</a>
									<div class="links"><a href="#">Branding,</a><a href="#">Fashion</a></div>
								</div>
							</div>
				...
				<div class="row">
					<div class="col-xl-3 col-lg-3 col-md-6 col-12">
						<div class="footer-media">
							<a href="index.html">
								<img src="assets/images/logo/about_logo.png" alt="footer-image">
							</a>
							<p>
...
<!-- Mirrored from labartisan.net/demo/halci/portfolio-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Dec 2022 06:26:11 GMT -->
</html>