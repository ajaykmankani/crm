...
<!-- Mirrored from labartisan.net/demo/halci/pricing.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Dec 2022 06:26:01 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
	...
	<title>Best Digital Marketing Company in Delhi NCR - mindyourads.com</title>
  </head>
  <body data-spy="scroll" class="p-0 overflow-auto">
			...
			<div class="container">
				<div class="banner-content">
					...
					<ul class="banner-link">
						...
						<li><span>/</span></li>
						<li><a class="active">Pricing Plan</a></li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="pricing-wrapper">
				<div class="row justify-content-center">
					<div class="col-xl-4 col-md-6 col-12">
						<div class="price-item text-center price-style">
	...
	<div class="price-categorises">
		<div class="container">
			<div class="categorises-tabale">
				<table>
					<tbody>
						<tr>
							<td class="text-left"><strong>Features</strong></td>
							<td><strong>Basic</strong></td>
							<td><strong>Standard</strong></td>
							<td><strong>Premium</strong></td>
						</tr>
						<tr>
							<td class="text-left"><span>Send unlimited e-mails</span></td>
							<td><i class="far fa-check-circle"></i></td>
							<td><i class="far fa-check-circle"></i></td>
							<td><i class="far fa-check-circle"></i></td>
						</tr>
						<tr>
							<td class="text-left"><span>Display personalized</span></td>
							<td><span><i class="far fa-check-circle"></i></span></td>
							<td><span><i class="far fa-check-circle"></i></span></td>
							<td><span><i class="far fa-check-circle"></i></span></td>
						</tr>
						<tr>
							<td class="text-left"><span>Send text messages</span></td>
							<td><i class="far fa-check-circle"></i></td>
							<td><i class="far fa-check-circle"></i></td>
							<td><i class="far fa-check-circle"></i></td>
						</tr>
						<tr>
							<td class="text-left"><span>Send live message alerts</span></td>
							<td><i class="fas fa-times-circle"></i></td>
							<td><i class="far fa-check-circle"></i></td>
							<td><i class="far fa-check-circle"></i></td>
						</tr>
						<tr>
							<td class="text-left"><span>Organize contacts into</span></td>
							<td><i class="fas fa-times-circle"></i></td>
							<td><i class="fas fa-times-circle"></i></td>
							<td><i class="far fa-check-circle"></i></td>
						</tr>
						<tr>
							<td class="text-left"><span>Create smart segment us</span></td>
							<td><i class="fas fa-times-circle"></i></td>
							<td><i class="fas fa-times-circle"></i></td>
							<td><i class="far fa-check-circle"></i></td>
						</tr>
