...
<!-- Mirrored from labartisan.net/demo/halci/shop-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Dec 2022 06:26:24 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
											...
											<ul class="mega-menu">
												<li>
													...
													<ul>
														...
														<li class="active"><a href="shop-cart.html">Cart Page</a></li>
	...
	<div class="shop-cart padding-tb">
		<div class="container">
			<div class="section-wrapper">
						...
						<tbody>
							<tr>
								<td class="product-item">
									<div class="p-thumb">
										<a href="#"><img src="assets/images/shope/01.jpg" alt="product"></a>
									</div>
									<div class="p-content">
								...
								<td>$750</td>
								<td>
									<a href="#"><img src="assets/images/shope/del.png" alt="product"></a>
								</td>
							</tr>
							<tr>
								<td class="product-item">
									<div class="p-thumb">
										<a href="#"><img src="assets/images/shope/02.jpg" alt="product"></a>
									</div>
									<div class="p-content">
										<a href="#">Product Title Here</a>
									</div>
							...
							<tr>
								<td class="product-item">
									<div class="p-thumb">
										<a href="#"><img src="assets/images/shope/03.jpg" alt="product"></a>
									</div>
									<div class="p-content">
										<a href="#">Product Title Here</a>
									</div>
							...
							<tr>
								<td class="product-item">
									<div class="p-thumb">
										<a href="#"><img src="assets/images/shope/04.jpg" alt="product"></a>
									</div>
									<div class="p-content">
										<a href="#">Product Title Here</a>
									</div>
							...
							<tr>
								<td class="product-item">
									<div class="p-thumb">
										<a href="#"><img src="assets/images/shope/05.jpg" alt="product"></a>
									</div>
									<div class="p-content">
										<a href="#">Product Title Here</a>
									</div>
				...
				<div class="cart-bottom">
					<form action="https://labartisan.net/" class="cart-checkout-box">
						<div class="coupon">
					...
					<form action="https://labartisan.net/" class="shiping-box">
						<div class="row">
							<div class="col-md-6 col-12">
								<div class="calculate-shiping">
									...
									<button type="submit" class="submit-btn">Update Total</button>
								</div>
							</div>
							<div class="col-md-6 col-12">
...
<!-- Mirrored from labartisan.net/demo/halci/shop-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Dec 2022 06:26:25 GMT -->
</html>