...
<!-- Mirrored from labartisan.net/demo/halci/shop-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Dec 2022 06:26:22 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body data-spy="scroll" class="p-0 overflow-auto">
											...
											<ul class="mega-menu">
												<li>
													...
													<ul>
														...
														<li class="active"><a href="shop-single.html">Shop Single</a></li>
	...
	<!-- banner area start -->
	<div class="page-header style-3 style-9">
		<div class="banner-position">
			<div class="container">
				<div class="banner-content text-center">
					<h3>Shop Single Page</h3>
					<ul class="banner-link">
						<li><a href="index.html">Home</a></li>
						<li><span>/</span></li>
						<li><a class="active">Shop Single Page</a></li>
					</ul>
				</div>
			</div>
		</div>
	...
	<section class="shop-single padding-tb">
		<div class="container">
			<div class="row justify-content-center">
										...
										<div class="swiper-wrapper">
											<div class="swiper-slide">
												<div class="thumb text-center">
													<img src="assets/images/shope/01.jpg" alt="food-image">
												</div>
											</div>
											<div class="swiper-slide">
												<div class="thumb text-center">
													<img src="assets/images/shope/02.jpg" alt="food-image">
												</div>
											</div>
											<div class="swiper-slide">
												<div class="thumb text-center">
													<img src="assets/images/shope/03.jpg" alt="food-image">
												</div>
											</div>
											<div class="swiper-slide">
												<div class="thumb text-center">
													<img src="assets/images/shope/04.jpg" alt="food-image">
												</div>
											</div>
											<div class="swiper-slide">
												<div class="thumb text-center">
													<img src="assets/images/shope/05.jpg" alt="food-image">
												</div>
											</div>
											<div class="swiper-slide">
												<div class="thumb text-center">
													<img src="assets/images/shope/06.jpg" alt="food-image">
												</div>
											</div>
										</div>
										<!-- Add Arrows -->
					...
					<div class="review">
						...
						<div class="review-content review-content-show">
							<div class="review-showing">
								<ul class="content">
									<li>
										<div class="post-thumb">
											<img src="assets/images/shope/review/01.jpg" alt="shop">
										</div>
										<div class="post-content">
									...
									<li>
										<div class="post-thumb">
											<img src="assets/images/shope/review/02.jpg" alt="shop">
										</div>
										<div class="post-content">
											<div class="entry-meta">
												<div class="posted-on">
									...
									<li>
										<div class="post-thumb">
											<img src="assets/images/shope/review/03.jpg" alt="shop">
										</div>
										<div class="post-content">
											<div class="entry-meta">
												<div class="posted-on">
									...
									<li>
										<div class="post-thumb">
											<img src="assets/images/shope/review/04.jpg" alt="shop">
										</div>
										<div class="post-content">
											<div class="entry-meta">
												<div class="posted-on">
								...
								<div class="client-review">
									<div class="review-form">
										...
										<form action="https://labartisan.net/demo/halci/action" class="row">
							...
							<div class="description">
								...
								<div class="post-item">
									<div class="post-thumb">
										<img src="assets/images/shope/desc.jpg" alt="shop">
									</div>
									<div class="post-content">
										<ul>
											<li>
				...
				<div class="col-lg-3 col-md-7 col-12 sticky-widget">
					<div class="sidebar-widget">
						<div class="widget-search">
                            <h4>Search Keyword</h4>
                            <form action="https://labartisan.net/demo/halci/action">
								...
								<ul class="shop-menu">
									<li>
										...
										<ul class="shop-submenu">
											...
											<li><a href="#">Butter 2</a></li>
											<li><a href="#">Butter 3</a></li>
										</ul>
									</li>
									<li><a href="#0">Cheese</a>
										<ul class="shop-submenu">
											<li><a href="#">Cheese 1</a></li>
										</ul>
									</li>
									<li><a href="#0">Ice Cream</a>
										<ul class="shop-submenu">
											<li><a href="#">Ice Cream 1</a></li>
											<li><a href="#">Ice Cream 2</a></li>
										</ul>
									</li>
									<li><a href="#0">Milk</a>
										<ul class="shop-submenu">
											<li><a href="#">Milk 1</a></li>
											<li><a href="#">Milk 2</a></li>
											<li><a href="#">Milk 3</a></li>
											<li><a href="#">Milk 4</a></li>
											<li><a href="#">Milk 5</a></li>
										</ul>
									</li>
									<li><a href="#0">Uncategorized</a>
										<ul class="shop-submenu">
											<li><a href="#">Uncategorized 1</a></li>
											<li><a href="#">Uncategorized 2</a></li>
										</ul>
									</li>
									<li><a href="#0">Yoghurt</a>
										<ul class="shop-submenu">
											<li><a href="#">Yoghurt 1</a></li>
											<li><a href="#">Yoghurt 2</a></li>
											<li><a href="#">Yoghurt 3</a></li>
										</ul>
									</li>
									<li><a href="#0">Cream</a>
										<ul class="shop-submenu">
											<li><a href="#">Cream 1</a></li>
											<li><a href="#">Cream 2</a></li>
											<li><a href="#">Cream 3</a></li>
											<li><a href="#">Cream 4</a></li>
											<li><a href="#">Cream 5</a></li>
										</ul>
									</li>
								</ul>
							</div>
						...
						<div class="letest-product">
							...
							<div class="widget-wrapper">
								<ul>
									<li>
										<div class="product-thumb">
											<img src="assets/images/shope/01.jpg" alt="shope">
										</div>
									...
									<li>
										<div class="product-thumb">
											<img src="assets/images/shope/02.jpg" alt="shope">
										</div>
										<div class="product-content">
											<h6><a href="#">Product Title Here</a></h6>
											<p>
									...
									<li>
										<div class="product-thumb">
											<img src="assets/images/shope/03.jpg" alt="shope">
										</div>
										<div class="product-content">
											<h6><a href="#">Product Title Here</a></h6>
											<p>
									...
									<li>
										<div class="product-thumb">
											<img src="assets/images/shope/04.jpg" alt="shope">
										</div>
										<div class="product-content">
											<h6><a href="#">Product Title Here</a></h6>
											<p>
...
<!-- Mirrored from labartisan.net/demo/halci/shop-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Dec 2022 06:26:24 GMT -->
</html>