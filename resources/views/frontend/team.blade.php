...
<!-- Mirrored from labartisan.net/demo/halci/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Dec 2022 06:25:59 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
			...
			<div class="section-wrapper">
				<div class="row justify-content-center">
					...
					<div class="col-xl-3 col-lg-4 col-md-6 col-12">
						<div class="team-content text-center">
							<div class="team-thumb">
								<img src="assets/images/team/05.png" alt="tema-image">
							</div>
							<div class="team-text">
								<a href="#"><h4>Jacklen khan</h4></a>
								<p>Designer</p>
								<ul class="tema-icon">
									<li><a href="#"><i class="fab fa-twitter"></i></a></li>
									<li><a href="#"><i class="fab fa-behance"></i></a></li>
					...
					<div class="col-xl-3 col-lg-4 col-md-6 col-12">
						<div class="team-content text-center">
							<div class="team-thumb">
								<img src="assets/images/team/06.png" alt="tema-image">
							</div>
							<div class="team-text">
								<a href="#"><h4>Somrat Sahjahan </h4></a>
								<p>App Designer</p>
								<ul class="tema-icon">
									<li><a href="#"><i class="fab fa-twitter"></i></a></li>
									<li><a href="#"><i class="fab fa-behance"></i></a></li>
					...
					<div class="col-xl-3 col-lg-4 col-md-6 col-12">
						<div class="team-content text-center">
							<div class="team-thumb">
								<img src="assets/images/team/07.png" alt="tema-image">
							</div>
							<div class="team-text">
								<a href="#"><h4>Nusrat Kabir</h4></a>
								<p>Marketer</p>
								<ul class="tema-icon">
									<li><a href="#"><i class="fab fa-twitter"></i></a></li>
									<li><a href="#"><i class="fab fa-behance"></i></a></li>
					...
					<div class="col-xl-3 col-lg-4 col-md-6 col-12">
						<div class="team-content text-center">
							<div class="team-thumb">
								<img src="assets/images/team/08.png" alt="tema-image">
							</div>
							<div class="team-text">
								<a href="#"><h4>Jeson Smith</h4></a>
								<p>Ui Designer</p>
...
<!-- Mirrored from labartisan.net/demo/halci/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Dec 2022 06:26:01 GMT -->
</html>